        ...
        if ub.WIN32:
            ...
            if 0:
                ...
                if not exists('setup.py'):
                    raise AssertionError('We must have a setup.py')
                repo._cmd('pip install -e .', cwd=repo.dpath)

    def doctest(repo):
        if 1:
            raise NotImplementedError('TODO: Make non-netharny')
...
DEVEL_REPOS = [
    {
        'name': 'sail-on-api', 'branch': 'master', 'remote': 'origin',
        'remotes': {'origin': 'git@gitlab.kitware.com:darpa-sail-on/sail-on-api.git'},
    },
    {
        'name': 'evm_based_novelty_detector', 'branch': 'new_tinker_mod', 'remote': 'origin',
        'remotes': {'origin': 'git@gitlab.kitware.com:darpa-sail-on/evm_based_novelty_detector.git'},
    },
    {
        'name': 'graph-autoencoder', 'branch': 'new_tinker_mod', 'remote': 'origin',
        'remotes': {'origin': 'git@gitlab.kitware.com:darpa-sail-on/graph-autoencoder.git'},
    },
    {
        'name': 'hwr_novelty_detector', 'branch': 'new_tinker_mod', 'remote': 'origin',
        'remotes': {'origin': 'git@gitlab.kitware.com:darpa-sail-on/hwr_novelty_detector.git'},
    },
    {
        'name': 'SMQTK', 'branch': 'prr-diyai-20201015', 'remote': 'origin',
        'remotes': {'origin': 'git@kwgitlab.kitware.com:computer-vision/SMQTK.git'},
    },
    {
        'name': 'tinker-engine', 'branch': 'configuration-handling', 'remote': 'origin',
    ...
    {
        'name': 'sailon_tinker_launcher', 'branch': 'master', 'remote': 'origin',
        'remotes': {'origin': 'git@gitlab.kitware.com:darpa-sail-on/sailon_tinker_launcher.git'},
    },
]
...
def main():
    ...
    main_repo = None
    MAIN_REPO_NAME = 'sailon_tinker_launcher'
    for repo in registery.repos:
